...
var (
	...
	templatesDir = flag.String("templates", "/home/stgleb/go/src/github.com/supergiant/supergiant/templates", "supergiant will load script templates from the specified directory on start")
