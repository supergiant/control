...
// ui/assets/fonts/Lato-Bold.woff
// ui/assets/fonts/Lato-Bold.woff2
// ui/assets/fonts/Lato-Italic.woff
// ui/assets/fonts/Lato-Italic.woff2
// ui/assets/fonts/Lato-Light.woff
// ui/assets/fonts/Lato-Light.woff2
// ui/assets/fonts/Lato-Regular.woff
// ui/assets/fonts/Lato-Regular.woff2
// ui/assets/fonts/Lato-Semibold.woff
// ui/assets/fonts/Lato-Semibold.woff2
...
// uiAssetsFontsLatoBoldWoff reads file data from disk. It returns an error on failure.
func uiAssetsFontsLatoBoldWoff() (*asset, error) {
	path := "/Users/Scott/golang/src/github.com/supergiant/supergiant/ui/assets/fonts/Lato-Bold.woff"
	name := "ui/assets/fonts/Lato-Bold.woff"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// uiAssetsFontsLatoBoldWoff2 reads file data from disk. It returns an error on failure.
func uiAssetsFontsLatoBoldWoff2() (*asset, error) {
	path := "/Users/Scott/golang/src/github.com/supergiant/supergiant/ui/assets/fonts/Lato-Bold.woff2"
	name := "ui/assets/fonts/Lato-Bold.woff2"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// uiAssetsFontsLatoItalicWoff reads file data from disk. It returns an error on failure.
func uiAssetsFontsLatoItalicWoff() (*asset, error) {
	path := "/Users/Scott/golang/src/github.com/supergiant/supergiant/ui/assets/fonts/Lato-Italic.woff"
	name := "ui/assets/fonts/Lato-Italic.woff"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// uiAssetsFontsLatoItalicWoff2 reads file data from disk. It returns an error on failure.
func uiAssetsFontsLatoItalicWoff2() (*asset, error) {
	path := "/Users/Scott/golang/src/github.com/supergiant/supergiant/ui/assets/fonts/Lato-Italic.woff2"
	name := "ui/assets/fonts/Lato-Italic.woff2"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// uiAssetsFontsLatoLightWoff reads file data from disk. It returns an error on failure.
func uiAssetsFontsLatoLightWoff() (*asset, error) {
	path := "/Users/Scott/golang/src/github.com/supergiant/supergiant/ui/assets/fonts/Lato-Light.woff"
	name := "ui/assets/fonts/Lato-Light.woff"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// uiAssetsFontsLatoLightWoff2 reads file data from disk. It returns an error on failure.
func uiAssetsFontsLatoLightWoff2() (*asset, error) {
	path := "/Users/Scott/golang/src/github.com/supergiant/supergiant/ui/assets/fonts/Lato-Light.woff2"
	name := "ui/assets/fonts/Lato-Light.woff2"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// uiAssetsFontsLatoRegularWoff reads file data from disk. It returns an error on failure.
func uiAssetsFontsLatoRegularWoff() (*asset, error) {
	path := "/Users/Scott/golang/src/github.com/supergiant/supergiant/ui/assets/fonts/Lato-Regular.woff"
	name := "ui/assets/fonts/Lato-Regular.woff"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// uiAssetsFontsLatoRegularWoff2 reads file data from disk. It returns an error on failure.
func uiAssetsFontsLatoRegularWoff2() (*asset, error) {
	path := "/Users/Scott/golang/src/github.com/supergiant/supergiant/ui/assets/fonts/Lato-Regular.woff2"
	name := "ui/assets/fonts/Lato-Regular.woff2"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// uiAssetsFontsLatoSemiboldWoff reads file data from disk. It returns an error on failure.
func uiAssetsFontsLatoSemiboldWoff() (*asset, error) {
	path := "/Users/Scott/golang/src/github.com/supergiant/supergiant/ui/assets/fonts/Lato-Semibold.woff"
	name := "ui/assets/fonts/Lato-Semibold.woff"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// uiAssetsFontsLatoSemiboldWoff2 reads file data from disk. It returns an error on failure.
func uiAssetsFontsLatoSemiboldWoff2() (*asset, error) {
	path := "/Users/Scott/golang/src/github.com/supergiant/supergiant/ui/assets/fonts/Lato-Semibold.woff2"
	name := "ui/assets/fonts/Lato-Semibold.woff2"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
var _bindata = map[string]func() (*asset, error){
	...
	"ui/assets/fonts/Lato-Bold.woff": uiAssetsFontsLatoBoldWoff,
	"ui/assets/fonts/Lato-Bold.woff2": uiAssetsFontsLatoBoldWoff2,
	"ui/assets/fonts/Lato-Italic.woff": uiAssetsFontsLatoItalicWoff,
	"ui/assets/fonts/Lato-Italic.woff2": uiAssetsFontsLatoItalicWoff2,
	"ui/assets/fonts/Lato-Light.woff": uiAssetsFontsLatoLightWoff,
	"ui/assets/fonts/Lato-Light.woff2": uiAssetsFontsLatoLightWoff2,
	"ui/assets/fonts/Lato-Regular.woff": uiAssetsFontsLatoRegularWoff,
	"ui/assets/fonts/Lato-Regular.woff2": uiAssetsFontsLatoRegularWoff2,
	"ui/assets/fonts/Lato-Semibold.woff": uiAssetsFontsLatoSemiboldWoff,
	"ui/assets/fonts/Lato-Semibold.woff2": uiAssetsFontsLatoSemiboldWoff2,
	...
	"ui": &bintree{nil, map[string]*bintree{
		"assets": &bintree{nil, map[string]*bintree{
			...
			"fonts": &bintree{nil, map[string]*bintree{
				...
				"Lato-Bold.woff": &bintree{uiAssetsFontsLatoBoldWoff, map[string]*bintree{}},
				"Lato-Bold.woff2": &bintree{uiAssetsFontsLatoBoldWoff2, map[string]*bintree{}},
				"Lato-Italic.woff": &bintree{uiAssetsFontsLatoItalicWoff, map[string]*bintree{}},
				"Lato-Italic.woff2": &bintree{uiAssetsFontsLatoItalicWoff2, map[string]*bintree{}},
				"Lato-Light.woff": &bintree{uiAssetsFontsLatoLightWoff, map[string]*bintree{}},
				"Lato-Light.woff2": &bintree{uiAssetsFontsLatoLightWoff2, map[string]*bintree{}},
				"Lato-Regular.woff": &bintree{uiAssetsFontsLatoRegularWoff, map[string]*bintree{}},
				"Lato-Regular.woff2": &bintree{uiAssetsFontsLatoRegularWoff2, map[string]*bintree{}},
				"Lato-Semibold.woff": &bintree{uiAssetsFontsLatoSemiboldWoff, map[string]*bintree{}},
				"Lato-Semibold.woff2": &bintree{uiAssetsFontsLatoSemiboldWoff2, map[string]*bintree{}},
