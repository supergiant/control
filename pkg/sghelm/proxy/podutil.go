...
// getPodReadyCondition extracts the pod ready condition from the given pod and returns that.
...
// getPodCondition extracts the provided condition from the given pod and returns that.
